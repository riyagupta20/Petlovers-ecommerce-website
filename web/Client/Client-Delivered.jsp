...
<html>
    ...
    <body>
        ...
        <form action="../Client/Client-Delivery-Back.jsp" method="post" class="text-center mt-5">
            <img src="../All-Images/<%= file%>" class="card-img-top rounded mx-auto d-block" style="width: 10rem;" 
                 style="width: 70%;">
            <h4 class="card-title mb-3" style="font-family: cursive; font-weight: bold;"><c:out value="<%=name%>"/></h4>
            ...
            <input name="dod" value="31.05.23" disabled><br><br>
            <input class="btn btn-primary fs-6" type="submit" name="btn" value="Confirm Delivery">

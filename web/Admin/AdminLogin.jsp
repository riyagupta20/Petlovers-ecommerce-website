...
<form action="AdminLogin-Back.jsp">
<div class="container col-lg-5 mt-4">
    <div class="card border-0">
        <div class="row">
            <h2 class="text-center mt-4" style="font-family: cursive">Admin Here</h2>
            ...
            <div class="col-5 ms-5 mt-4 ps-3 mb-4">
                <a href="Admin-Form-Products-Input.jsp" class="btn btn-primary">Submit</a>
            </div>
        </div>
    </div>
</div>

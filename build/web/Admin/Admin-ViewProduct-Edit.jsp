...
<%
    ...
    String id= (String)httpSession.getAttribute("p_id");
%>
<body>
<%@include file="../Same-Code/Header-Main.jsp"%>
<div class="container">
    <form action="Admin-Edit-Back.jsp" method="post" class="row mt-5 g-3">
    ...
    <div class="col-md-4">
        ...
        <input type="file" name="file" class="form-control" value="<%= file%>" id="inputEmail4">
    </div>
    <div class="col-md-4">
        <label for="inputEmail4" class="form-label">Product Name:</label>
        <input type="text" name="name" class="form-control" value="<%= name%>" id="inputEmail4" 
               placeholder="Enter a Product Name">
    </div>
    <div class="col-md-4 mb-3">
        <label for="inputPassword4" class="form-label">Product Price:</label>
        <input type="number" name="price" class="form-control" value="<%= price%>" id="inputPassword4" 
               placeholder="Enter a Product Price">
    </div>
    <div class="col-6">
        <label for="inputAddress" class="form-label">Product Description:</label>
        <input type="text" name="info" class="form-control" value="<%= info%>" id="inputAddress" 
               placeholder="Enter a Product Description">
    </div>
    <div class="col-6 mb-3">
        <label for="inputAddress2" class="form-label">Product Id:</label>
        <input name="p_id" value="<%= id%>" hidden>
    </div>
